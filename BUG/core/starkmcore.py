...
def Fix():
 ...
 if Fix == "1":
     ...
     print_slow(colored("""daca primesti in continuu aceasta eroare\n o rezolvi de aci. :)""","red"))
...
def About():
	print_slow(colored("Salut sunt B.U.G\nmuie Pankea si BuToI xD.!", 'red'))
	backtomenu()
